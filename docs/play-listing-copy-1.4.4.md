...
## Release notes for the AAB upload (internal testing, v1.4.4, versionCode 11)
```
...
1. AAB: `server/static/apk/magneetar-v1.4.4-play.aab` (versionCode 11,
   SHA-256 `6510cf41…`, zero SMS, zero accessibility service — verified).
