...
export function VersionBadge() {
  ...
  return (
    <div
      className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border-mag-border/50 bg-mag-surface mb-7"
      title={
        status === 'online'
    ...
    >
      ...
      <span className="text-[11px] font-mono font-bold tracking-wider text-mag-text-muted">{label}</span>
    </div>
  );
}
